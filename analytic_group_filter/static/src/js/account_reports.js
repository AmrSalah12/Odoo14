odoo.define('dawaa_profit_loss_filter.account_report', function (require){
'use strict';
...
var M2MFilters = Widget.extend(StandaloneFieldManagerMixin, {
    ...
    init: function (parent, fields) {
        ...
        // Inherit
        fields['analytic_account_groups'] = {label: 'Account Groups', modelName: 'account.analytic.group', value: []}
        // 
        this.fields = fields;
        this.widgets = {};
    },
...
var accountReportsWidgetNew = accountReportsWidget.include({
    ...
    custom_events: {
        'value_changed': function(ev) {
             ...
             //  Inherit
             self.report_options.analytic_account_groups = ev.data.analytic_account_groups;
             // 
    ...
    render_searchview_buttons: function() {
        ...
        if (this.report_options.partner) {
            if (!this.M2MFilters) {
                ...
                // Inherit
                if (this.report_options.analytic_account_groups) {
                    fields['analytic_account_groups'] = {
                        label: _t('Analytic Account Group'),
                        modelName: 'account.analytic.group',
                        value: this.report_options.analytic_account_groups.map(Number),
                    };
                }
                // 
                if (!_.isEmpty(fields)) {
